            ...
            <div className="col-lg-6">
              <div className="about__content">
                <div className="section__title">
                  <span className="sub-title">Giới thiệu về Chúng tôi !</span>
                  <h2 className="title">
                ...
                <p className="desc">
                  Thiết kế website đa dạng, nhiều ngành nghề và lĩnh vực khác
                  nhau.​ Đội ngũ thiết kế website theo yêu cầu có chuyên môn cao
                  tân tâm đáng tin cậy. Chúng tôi có Đội ngũ chuyên gia làm
                  website có kinh nghiệm hơn 10 năm. Công nghệ hiện đại bảo mật
                  cao cấp. Đáp ứng mọi yêu cầu của khách hàng
                </p>
                <ul className="about__info-list list-wrap">
                  <li className="about__info-list-item">
                    <i className="flaticon-angle-right"></i>
                    <p className="content">NÂNG TẦM VỊ THẾ THƯƠNG HIỆU</p>
                  </li>
                  <li className="about__info-list-item">
                    <i className="flaticon-angle-right"></i>
                    <p className="content"> GIA TĂNG HIỆU QUẢ KINH DOANH</p>
                  </li>
                  <li className="about__info-list-item">
                    <i className="flaticon-angle-right"></i>
                    <p className="content">
                      Giao diện đẹp mắt, hiện đại, độc quyền{" "}
                    </p>
                  </li>
                </ul>
                <div className="tg-button-wrap">
                  <Link href="tel:0944390988" className="btn arrow-btn">
                    Hotline 0944 390 988 <BtnArrow />
                  </Link>
                </div>
              </div>
            </div>
