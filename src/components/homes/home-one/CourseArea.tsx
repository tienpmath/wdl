          ...
          <div className="row justify-content-center">
            <div className="col-lg-6">
              <div className="section__title text-center mb-40">
                <span className="sub-title">Dự án</span>
                <h2 className="title">Các dư án tiêu biểu</h2>
                <p className="desc">Khách hàng tiêu biểu</p>
              </div>
